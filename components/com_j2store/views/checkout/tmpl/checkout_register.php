...
<?php
$html = $this->storeProfile->store_register_layout;
...
$password .='<span class="required">*</span>'.JText::_('J2STORE_CHECKOUT_ENTER_PASSWORD');
$password .='<br /><input type="password" name="password" value="" class="large-field" /> <br /> <br />';
$confirm_password= '<span class="required">*</span>'.JText::_('J2STORE_CHECKOUT_CONFIRM_PASSWORD').'<br />
...
//re-check if password or confirm password fields are deleted. May be accidentally
$phtml = '';

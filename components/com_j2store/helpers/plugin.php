...
class J2StoreHelperPlugin
{
	 ...
	 */
public static	function getPluginsWithEvent( $eventName, $folder='J2Store' )
	{
		$return = array();
		if ($plugins = J2StoreHelperPlugin::getPlugins( $folder ))
		{
			foreach ($plugins as $plugin)
			{
				if (J2StoreHelperPlugin::hasEvent( $plugin, $eventName ))
				{
					$return[] = $plugin;
				}
			}

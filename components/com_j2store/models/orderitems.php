...
class J2StoreModelOrderItems extends J2StoreModelBase
{
	...
	{
		$query->join('LEFT', '#__content AS p ON tbl.product_id = p.id');
		$query->join('LEFT', '#__j2store_orders AS o ON tbl.order_id = o.order_id');
	}
	...
	public function getList($refresh = false)
	{
		...
		{
			$item->link = 'index.php?option=com_j2store&view=orderitems&task=edit&id='.$item->orderitem_id;
		}
		return $list;
	}
}

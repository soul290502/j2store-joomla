	...
	<table class="adminlist table table-striped" style="clear: both;">
		<thead>
            <tr>
				...
				<th class="title"><?php echo JText::_('J2STORE_SHIPM_ID'); ?></th>
				<th class="title"><?php echo JText::_('J2STORE_SHIPM_NAME'); ?></th>
                <th><?php echo JText::_('J2STORE_SFR_TAX_CLASS_NAME'); ?></th>
                <th><?php echo JText::_('J2STORE_SHIPM_STATE'); ?></th>
            </tr>
		</thead>
        <tfoot>
            <tr>
        ...
        <?php
            ...
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					...
					?>
					<a href="#" onclick="j2storePublishMethod(<?php echo $item->shipping_method_id; ?>)">

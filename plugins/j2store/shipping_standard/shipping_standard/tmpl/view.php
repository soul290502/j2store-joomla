...
<div class="span4">
    <div class="alert alert-block alert-info">
        ...
        <ul>
            ...
            <li><?php echo JText::_('J2STORE_WEIGHT-BASED_PER_ITEM_HELP_TEXT'); ?></li>
            <li><?php echo JText::_('J2STORE_WEIGHT-BASED_PER_ORDER_HELP_TEXT'); ?></li>
            <li><?php echo JText::_('J2STORE_PRICE-BASED_PER_ITEM_HELP_TEXT'); ?></li>
            <li><?php echo JText::_('J2STORE_QUANTITY-BASED_PER_ORDER_HELP_TEXT'); ?></li>
            <li><?php echo JText::_('J2STORE_PRICE-BASED_PER_ORDER_HELP_TEXT'); ?></li>
        </ul>
    </div>
</div>

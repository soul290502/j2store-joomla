            ...
            <div class="j2store">
						<div id="field">
							<div class="control-group">
									<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_CREDITCARD_HOLDERNAME');?></label>
									<div class="controls"><input class="paymill-card-holdername" name="cardholder" type="text" size="20"
									value="" />
									</div>
	                        </div>
	                        <div class="control-group">
								<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_PAYMENT_TYPE');?></label>
									<div class="controls">
                        ...
                        <div id="cc">
							<div class="control-group">
									<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_CARD_NUMBER');?></label>
							...
							<div class="control-group">
									<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_EXPIRATION_DATE');?></label>
								   <div class="controls">
								     <select name="month" class="required number" title="<?php echo JText::_('J2STORE_PAYMILL_VALIDATION_ENTER_EXPIRY_MONTH'); ?>">
						        ...
						        title="<?php echo JText::_('J2STORE_PAYMILL_VALIDATION_ENTER_EXPIRY_YEAR'); ?>"
						        >
							...
							<div class="control-group">
									<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_CARD_CVV');?></label>
                        ...
                        <div id="bank" style="display:none;">
									 ...
									 <div class="control-group">
											<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_DIRECTDEBIT_LABEL_NUMBER');?></label>
											<div class="controls"> <input class="paymill-debit-number" name="accnum" maxlength="10" type="text" size="20" value="" /></div>
									</div>
									 <div class="control-group">
											<label class="control-label"><?php echo JText::_('J2STORE_PAYMILL_DIRECTDEBIT_LABEL_BANKCODE');?></label>

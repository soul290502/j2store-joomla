 ...
 * 
 * */
$strVirtualDir = "pspfk2";

// Change if you have created a Virtual Directory in IIS with a different name
...
$strEncryptionPassword = $this->_getParam('enc_password');
...
/**
 * This can be DEFERRED or AUTHENTICATE if your Sage Pay account supports 
 * those payment types
 * */
...
/**
 * Optional setting. If you are a Sage Pay Partner and wish to flag the 
...
** 2 = Send Vendor Email but not Customer Email. If you do not supply this field, 
* 1 is assumed and e-mails are sent if addresses are provided. 
* */
...
/**
	...
	* NOTE: A function of convenience that extracts the value from the
	* "name=value&name2=value2..."reply string
	* Works even if one of the values is a URL containing the & or = signs
	* 
	* @param   string  $thisString  url access.
	*
	* @return  void
	*
	* @see process()
...
/**
	...
	* 
	* @param   string  $strRawText  input access.
	* @param   string  $strType     input access.
	*
	* @return  void
	*
	* @see process()
...
/**
	...
	* 
	* @param   string  $plain  input Encoding.
	*
	* @return  void
	*
	* @see process()
...
/**
	...
	* let's declare our own function.
	* 
	* @param   string  $scrambled  input Encoding.
	*
	* @return  void
	*
	* @see process()
...
/**
	...
	* 
	* @param   string  $InString  input Encoding.
	* @param   string  $Key       input Encoding.
	*
	* @return  void
	*
	* @see process()

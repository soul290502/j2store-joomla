...
class AController
{
	...
	public function getName()
	{
		if (empty($this->name))
		{
			...
			{
				throw new Exception(JText::_('ANGI_APPLICATION_ERROR_CONTROLLER_GET_NAME'), 500);
			}
	...
	public function getView($name = '', $type = '', $prefix = '', $config = array())
	{
		...
		if (empty($views[$name]))
		{
			...
			{
				throw new Exception(JText::sprintf('ANGI_APPLICATION_ERROR_VIEW_NOT_FOUND', $name, $type, $prefix), 500);
			}
		}

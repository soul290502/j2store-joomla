...
class J2StoreModelStoreProfiles extends JModelList {
	...
	protected function getListQuery()
	{
		...
		$query->from('#__j2store_storeprofiles AS a');

		$query->join('LEFT', '#__j2store_countries AS c ON c.country_id =a.country_id ');
		$query->join('LEFT', '#__j2store_zones AS z ON z.zone_id =a.zone_id ');

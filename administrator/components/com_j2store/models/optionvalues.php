...
class J2StoreModelOptionValues extends J2StoreModelBase
{
	...
	public function getList($refresh = false)
	{
		...
		{
			$item->link_remove = 'index.php?option=com_j2store&view=optionvalues&task=delete&cid[]='.$item->optionvalue_id;
		}

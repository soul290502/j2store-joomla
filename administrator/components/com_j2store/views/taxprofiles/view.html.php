...
class J2StoreViewTaxprofiles extends J2StoreView
{
	protected $items;
	...
	protected function setDocument() {
		...
		$document->setTitle(JText::_('J2STORE_TAXPROFILES'));
	}
	...
	protected function getSortFields()
	{
		return array(
				...
				'a.taxprofile_name' => JText::_('J2STORE_TAXPROFILE_NAME'),
				'a.taxprofile_id' => JText::_('J2STORE_TAXPROFILE_ID')
		);
	}

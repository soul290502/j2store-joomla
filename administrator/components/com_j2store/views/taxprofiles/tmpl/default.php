...
$action = JRoute::_('index.php?option=com_j2store&view=taxprofiles');
...
<form action="<?php echo $action;?>" name="adminForm" class="adminForm"
	...
	<table class="adminlist table table-striped">
		<thead>
			...
			<th class="id"><?php echo JHtml::_('grid.sort',  'J2STORE_TAXPROFILE_ID', 'a.taxprofile_id', $listDirn, $listOrder); ?>
			</th>
			<th class="name"><?php echo JHtml::_('grid.sort',  'J2STORE_TAXPROFILE_NAME', 'a.taxprofile_name', $listDirn, $listOrder); ?>
			</th>
		...
		<tbody>
			...
			<tr class="row<?php echo $i%2; ?>">
				...
				<td><a
					href="<?php echo JRoute::_('index.php?option=com_j2store&view=taxprofile&task=taxprofile.edit&taxprofile_id='.$item->taxprofile_id); ?>">

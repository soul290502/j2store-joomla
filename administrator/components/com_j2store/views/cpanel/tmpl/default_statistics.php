...
<h3><?php echo JText::_('J2STORE_ORDER_STATISTICS');?></h3>
	...
	<tbody>
		<tr>
			...
			<td>
			<?php
				echo J2StorePrices::number($this->order_model->clearState()->nozero(0)->moneysum(1)->getOrdersTotal());
			?>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
			<?php
				echo J2StorePrices::number($this->order_model->clearState()->paystate(1)->nozero(1)->moneysum(1)->getOrdersTotal());
			?>
			</td>
		</tr>

...
$action = JRoute::_('index.php?option=com_j2store&view=taxrates');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_j2store&task=taxrates.saveOrderAjax&tmpl=component';
		  ...
		  <label for="filter_search" >
		   ...
		   <table class="adminlist table table-striped" id="taxrateList">
			...
			<th width="1%" class="nowrap center hidden-phone"><?php echo JHtml::_('grid.sort', '<i class="icon-menu-2"></i>', 'a.ordering', $listDirn, $listOrder, null, 'asc', 'JGRID_HEADING_ORDERING'); ?>
				...
				<th class="id">
					<?php echo JHtml::_('grid.sort',  'J2STORE_TAXRATE_ID', 'a.taxrate_id', $listDirn, $listOrder); ?>
				</th>
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_TAXRATE_NAME', 'a.taxrate_name', $listDirn, $listOrder); ?>
				</th>

				<th class="country_name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_GEOZONE_NAME', 'g.geozone_name', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
			...
			<tbody>
				...
				<td class="order nowrap center hidden-phone"><?php if ($canChange) :
				     ...
				     <td>
				     <a href="index.php?option=com_j2store&view=taxrate&task=taxrate.edit&taxrate_id=<?php echo $item->taxrate_id; ?>">
				     <strong>

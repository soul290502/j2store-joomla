...
<div class="j2store">
<div class="j2store_help alert alert-info">
	<?php echo JText::_('J2STORE_STORE_PROFILES_HELP_TEXT'); ?>
</div>
		  ...
		  <label for="filter_search" >
		   ...
		   <table class="adminlist table table-striped" id="storeprofileList">
			...
			<th width="1%" class="nowrap center hidden-phone"><?php echo JHtml::_('grid.sort', '<i class="icon-menu-2"></i>', 'a.ordering', $listDirn, $listOrder, null, 'asc', 'JGRID_HEADING_ORDERING'); ?>
				...
				<th class="id">
					<?php echo JHtml::_('grid.sort',  'J2STORE_STORE_ID', 'a.store_id', $listDirn, $listOrder); ?>
				</th>
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_STORE_NAME', 'a.store_name', $listDirn, $listOrder); ?>
				</th>

				<th class="code">
					<?php echo JHtml::_('grid.sort',  'J2STORE_STORE_DESC', 'a.store_desc', $listDirn, $listOrder); ?>
				</th>
				<th class="country_name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_COUNTRY_NAME', 'c.country_name', $listDirn, $listOrder); ?>
				</th>
				<th class="country_name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_ZONE_NAME', 'z.zone_name', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
			...
			<tbody>
				...
				<td class="order nowrap center hidden-phone"><?php if ($canChange) :
				     ...
				     <td>
				     <a href="<?php echo 'index.php?option=com_j2store&view=storeprofile&task=storeprofile.edit&store_id='.$item->store_id; ?>">
				     	<?php echo $this->escape($item->store_name);?>
				     </a>
				      </td>

...
class J2StoreViewStoreprofiles extends J2StoreView
{
	protected $items;
	...
	protected function addToolBar() {
		...
		JToolBarHelper::title('J2Store - '.JText::_('J2STORE_STOREPROFILES'),'j2store-logo');
	...
	protected function setDocument() {
		...
		$document->setTitle(JText::_('J2STORE_STOREPROFILES'));
	...
	protected function getSortFields()
	{
		return array(
				...
				'a.store_name' => JText::_('COM_J2STORE_STORE_NAME'),
				'a.store_desc' => JText::_('COM_J2STORE_STORE_DESC')
		);
	}

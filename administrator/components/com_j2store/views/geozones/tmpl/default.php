...
$action = JRoute::_('index.php?option=com_j2store&view=geozones');
...
<form action="<?php echo $action;?>" name="adminForm" class="adminForm"
	...
	<table class="adminlist table table-striped">
		<thead>
			...
			<th class="id"><?php echo JHtml::_('grid.sort',  'J2STORE_GEOZONE_ID', 'a.geozone_id', $listDirn, $listOrder); ?>
			</th>
			<th class="name"><?php echo JHtml::_('grid.sort',  'J2STORE_GEOZONE_NAME', 'a.geozone_name', $listDirn, $listOrder); ?>
			</th>
		...
		<tbody>
			...
			<tr class="row<?php echo $i%2; ?>">
				...
				<td><a
					href="<?php echo JRoute::_('index.php?option=com_j2store&view=geozone&task=geozone.edit&geozone_id='.$item->geozone_id); ?>">
